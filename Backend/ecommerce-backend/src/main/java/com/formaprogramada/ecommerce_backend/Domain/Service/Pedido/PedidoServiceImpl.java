...
public class PedidoServiceImpl implements PedidoService {
    ...
    public List<PedidoDTO> verPedidosDeUsuario(int idUsuario) {
        System.out.println("🔍 verPedidosDeUsuario llamado con idUsuario: " + idUsuario);

        // 1️⃣ Traer pedidos con productos
        List<PedidoEntity> pedidos = jpaPedidoRepository.findPedidosConProductosPorUsuario(idUsuario);
        System.out.println("📦 Pedidos crudos obtenidos: " + pedidos.size());
        pedidos.forEach(p -> System.out.println(" - Pedido id: " + p.getId() + ", estado: " + p.getEstado()));
        ...
        List<Integer> productoIds = pedidos.stream()
                ...
                .distinct()
                .toList();
        System.out.println("🛠 IDs de productos a cargar archivos: " + productoIds);
        ...
        System.out.println("🖼 Productos con archivos obtenidos: " + productosConArchivos.size());
        ...
        pedidosDTO.forEach(p -> System.out.println(" - DTO id: " + p.getId() + ", estado: " + p.getEstado()));
